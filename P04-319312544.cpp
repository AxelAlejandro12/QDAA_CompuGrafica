...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glm::mat4 modelBase = glm::mat4(1.0f); // independiente
		modelBase = glm::translate(modelBase, glm::vec3(0.0f, 3.5f, -4.0f));
		modelBase = glm::scale(modelBase, glm::vec3(5.0f, 2.0f, 2.0f));
		...
		// ==== LLANTAS ====
		glm::mat4 ruedasBase = glm::mat4(1.0f); // matriz completamente independiente
		ruedasBase = glm::translate(ruedasBase, glm::vec3(0.0f, 3.0f, -4.0f)); // misma posición que la base

		// LLANTA DELANTERA IZQ
		model = glm::translate(ruedasBase, glm::vec3(-2.0f, -1.5f, 0.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, -1.0f)); // rotación propia
		...
		model = glm::translate(ruedasBase, glm::vec3(-2.0f, -1.5f, -0.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion6()), glm::vec3(0.0f, 0.0f, -1.0f)); // rotación propia
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0, 0, 1));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0, 0, 1));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1, 0, 0));
		model = glm::scale(model, glm::vec3(1.0f, 0.7f, 1.0f));
		...
		// LLANTA TRASERA IZQ
		model = glm::translate(ruedasBase, glm::vec3(2.0f, -1.5f, 0.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 0.0f, -1.0f)); // rotación propia
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0, 0, 1));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0, 0, 1));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1, 0, 0));
		model = glm::scale(model, glm::vec3(1.0f, 0.7f, 1.0f));
		...
		// LLANTA TRASERA DER
		model = glm::translate(ruedasBase, glm::vec3(2.0f, -1.5f, -0.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion8()), glm::vec3(0.0f, 0.0f, -1.0f)); // rotación propia
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0, 0, 1));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0, 0, 1));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1, 0, 0));
		model = glm::scale(model, glm::vec3(1.0f, 0.7f, 1.0f));
		...
		*/
		...
		//CERDITOOOOOO
		// ----- DENTRO DEL WHILE DEL MAIN -----
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -4.0f)); // baja el cuerpo un poco
		modelaux = model;
		...
		// --- OREJA IZQ ---
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 0.6f, -0.4f));
		...
		//OJO IZQ
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.401f, 0.2f, -0.2f));
		...
		//PUPILA IZQ
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.47f, 0.2f, -0.2f));
		...
		// --- NARIZ ---
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.5f, -0.15f, 0.0f));
		...
		// --- BOCA ---
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.551f, -0.15f, 0.1f));
		...
		// --- PATA DELANTERA IZQ (2 articulaciones) ---
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -4.0f)); // baja el cuerpo un poco
		model = glm::translate(model, glm::vec3(-0.8f, -0.5f, 0.5f));
		modelaux = model;
		...
		// --- PATA DELANTERA DER (2 articulaciones) ---
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -4.0f)); // baja el cuerpo un poco
		model = glm::translate(model, glm::vec3(-0.8f, -0.5f, -0.5f));
		modelaux = model;
		...
		// --- PATA TRASERA IZQ (2 articulaciones) ---
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -4.0f)); // baja el cuerpo un poco
		model = glm::translate(model, glm::vec3(0.8f, -0.5f, 0.5f));
		modelaux = model;
		...
		// --- PATA TRASERA DER (2 articulaciones) ---
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -4.0f)); // baja el cuerpo un poco
		model = glm::translate(model, glm::vec3(0.8f, -0.5f, -0.5f));
		modelaux = model;
